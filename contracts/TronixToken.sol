...
contract TronixToken is Ownable{

    using SafeMath for uint;

    string public constant symbol = 'Tronix';
    string public constant name = 'TRN';
    ...
    event AddToBlackList(address indexed _to);
    event RemoveFromBlackList(address indexed _to);
    event MintFinished();
    event MintStarted();
    ...
    */
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(!blacklist[_to] || !blacklist[msg.sender], "sender or receiver address is in blacklist");
